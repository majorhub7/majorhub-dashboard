  ...
  return (
    <div className="animate-fade-in space-y-12 pb-20 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between px-2">
          ...
          {currentUser.accessLevel === 'MANAGER' && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-slate-900/10 active:scale-95 transition-all hover:bg-slate-800 dark:hover:bg-slate-100"
            >
      ...
      <InviteMemberModal
        ...
        clientId={selectedClient?.id || currentUser.clientId || ''}
